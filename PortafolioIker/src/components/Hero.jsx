...
useEffect(() => {
  ...
  // Estilo para el nuevo botón de CV (sin cambios)
  const cvButtonColors = isDarkMode
    ? 'bg-emerald-600 hover:bg-emerald-500 text-white'
    : 'bg-emerald-700 hover:bg-emerald-600 text-white';

  // Lógica del CV (sin cambios)
  ...
  return (
    ...
    >
      ...
      >
        {/* Contenedor de Imagen + "Disponible" */}
        {/* --- INICIO DE MODIFICACIÓN: Eliminada la translación del contenedor --- */}
        <motion.div
          variants={itemVariants}
          className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6" // Clase original sin 'transform'
        >
        {/* --- FIN DE MODIFICACIÓN --- */}
          {/* --- INICIO DE MODIFICACIÓN: Añadida clase object-position a la imagen --- */}
      <div
