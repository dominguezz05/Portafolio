...
export default function CarruselPortfolio() {
  ...
  const textGradient_dark =
    "linear-gradient(90deg, #e0e0e0 30%, #999999 50%, #e0e0e0 70%)"; // Texto claro para tema oscuro
  ...
  const textGradient_light =
    "linear-gradient(90deg, #374151 30%, #1f2937 50%, #374151 70%)"; // Texto oscuro para tema claro

  const mainBackgroundColor = isDarkMode
    ? mainBackgroundColor_dark
    : mainBackgroundColor_light;
  const stripBackgroundColor = isDarkMode
    ? stripBackgroundColor_dark
    : stripBackgroundColor_light;
  const overlayBackgroundColor = isDarkMode
    ? overlayBackgroundColor_dark
    : overlayBackgroundColor_light;
