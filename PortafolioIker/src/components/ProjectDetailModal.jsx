...
function ProjectDetailModal({ project, onClose }) {
  ...
  const detailSections = [
    ...
    {
      titleKey: "techStackDetailsTitle",
      content: getLangContent("techStackDetails"),
    },
    {
      titleKey: "challengesTitle",
      content: renderList(getLangContent("challenges")),
    },
    {
      titleKey: "solutionsTitle",
      content: renderList(getLangContent("solutions")),
    },
  ...
  return (
    <AnimatePresence>
      {project && (
        ...
        >
          <motion.div
            className={`relative rounded-xl shadow-2xl max-w-3xl w-full max-h-[90vh]
              ${
                isDarkMode
          ...
          >
            ...
            <div
              ...
              className="max-h-[calc(90vh-72px)] overflow-y-auto p-6 md:p-8 space-y-5 text-sm md:text-base leading-relaxed"
            >
              {project.detailedDescription_es && (
                <p className="italic text-md mb-6">
                  {getLangContent("detailedDescription")}
                </p>
              )}
              ...
              {project.extraImages && project.extraImages.length > 0 && (
                <DetailSection
                  title={currentModalTexts.additionalGalleryTitle}
                  isDarkMode={isDarkMode}
                  content={
                    <Swiper
              ...
              {project.videoUrl && (
                <DetailSection
                  title={currentModalTexts.videoDemoTitle}
                  isDarkMode={isDarkMode}
                  content={
