...
function CertificationDetailModal({
  ...
  return (
    <AnimatePresence>
      ...
      >
        <motion.div
          className={`relative rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col
            ${
              isDarkMode
        ...
        >
          ...
          {/* ✅ Body scrolleable + Lenis no lo intercepta */}
          <div
            data-lenis-prevent
            data-lenis-prevent-wheel
            data-lenis-prevent-touch
            className="flex-1 overflow-y-auto p-6 md:p-8 space-y-5 text-sm md:text-base leading-relaxed"
          >
